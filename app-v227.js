console.log("[Vendify] v2.27 loaded");
/**
 * Vendify v2.27 — Login dual y empleados internos
...
// =====================
function abrirVenta() {
  if (!appContext?.cashRegister?.id) { mostrarToast("Seleccioná una caja antes de vender", "error"); return; }
  if (!cajaAbiertaMiaV227()) { mostrarToast(cajaEstadoV227?.sesion ? "Esta caja está abierta por otro usuario" : "Abrí la caja antes de comenzar a vender", "info"); abrirPanelCajaV227(); return; }
  carrito = [];
  $("#venta-buscador").value = "";
  $("#medio-pago").value = "Efectivo";
  renderVentaProductos(); renderCarrito(); $("#modal-venta").classList.remove("hidden");
...
// ============================================================
// Vendify v2.27 — Sucursales / cajas / stock por sucursal
// ============================================================
