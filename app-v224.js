console.log("[Vendify] v2.24 loaded");
/**
 * Vendify v2.24 — Login dual y empleados internos
...
function activarTabConfigV224(tab) {
  ...
  document.querySelectorAll(".config-tab-v224").forEach((btn) => {
    btn.classList.toggle("active", btn.dataset.configTab === target);
  });
